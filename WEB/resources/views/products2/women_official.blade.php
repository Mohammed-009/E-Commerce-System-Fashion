            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form action="{{route('storeWomenOfficial')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <span><input type="reset" name="submit" value="reset" class="btn btn-secondary btn-sm"></span>
                                </div>
                            </form>
                        </div>
                    </div>
